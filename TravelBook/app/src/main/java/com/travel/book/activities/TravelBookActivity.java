package com.travel.book.activities;
...
import com.travel.book.expandable.ExpandableLayout;
import com.travel.book.R;
import com.travel.book.adapters.TravelBookAdapter;
import com.travel.book.interfaces.GetDataService;
import com.travel.book.model.TravelModel;
import com.travel.book.network.RetrofitInstance;
import com.travel.book.receivers.ConnectivityReceiver;
import com.travel.book.receivers.TravelBookApplication;
...
//    private static final String ACCESS_TOKEN = "67561edf2ef10382826457f0d56e851644058b6a10769bbc15915b1017feb716";
    ...
    private void loadingAppSetting() {
        ...
        if (sharedPreferences != null) {
            scopes = sharedPreferences.getString("scopes", "friends");
            if (scopes.equals("friends")) {
                friend.setTextColor(Color.argb(255, 236, 81, 105));
                community.setTextColor(Color.argb(255, 0, 0, 0));
            } else if (scopes.equals("community")) {
